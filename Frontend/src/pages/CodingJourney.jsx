...
const CodingJourney = () => {
  ...
  // Sidebar link highlight matching structure
  const navItems = [
    ...
    { name: "Coding Journey", icon: Code2, active: true, path: "/coding-journey" },
          ...
          <header className="sticky top-0 z-30 bg-[#050B1F]/70 backdrop-blur-md border-b border-white/5 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center space-x-4 flex-1 max-w-lg">
              ...
              <div className="relative w-full group">
                ...
                <input
                  ...
                  placeholder="Search coding problems by name..."
            ...
            <div className="flex items-center space-x-6 shrink-0 pl-4">
              ...
              <div className="flex items-center space-x-2 bg-indigo-500/10 border border-indigo-500/20 px-3 py-1 rounded-xl">
                <span className="text-xs font-semibold text-indigo-300">Empty State Demo:</span>
                <button
              ...
              <div className="flex items-center space-x-3 border-l border-white/5 pl-6">
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-semibold text-white">Welcome, {user?.name?.split(" ")[0] || "User"}</p>
